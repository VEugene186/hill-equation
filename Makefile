all: tools
	g++ --std=c++11 --openmp Equation.o Mathieu.o Mathieu2.o LiouvilleHill2.o EulerPoisson.o RungeKutta.o EulerPoissonFixedPoints.o EulerPoissonTracker.o main.cpp -o main
